...
Others have loosely addressed the question of generaltiy by showing how features from higher layers in a convnet can be transferred to new tasks \citep{donahue+jia-2013-arxiv}, but here we systematically characterize the general to specific transition, which yields the next three results.
